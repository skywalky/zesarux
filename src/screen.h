...
#define OSDOS_TOTAL_PALETTE_COLOURS 5

#define OSDOS_COLOUR_BLUE_PAPER_TITLE (OSDOS_INDEX_FIRST_COLOR+0)
#define OSDOS_COLOUR_GRAY_INACTIVE_PAPER_TITLE (OSDOS_INDEX_FIRST_COLOR+1)
#define OSDOS_COLOUR_GRAY (OSDOS_INDEX_FIRST_COLOR+2)
#define OSDOS_COLOUR_GRAY_SELECTED_PAPER (OSDOS_INDEX_FIRST_COLOR+3)
#define OSDOS_COLOUR_GRAY_UNAVAILABE_ITEM (OSDOS_INDEX_FIRST_COLOR+4)
