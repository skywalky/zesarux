...
//M letter modified to be able to reduce to 7 pixel width and don't lose the first colum of pixels
//just shift 1 pixel to the right
//original
//0x82,0xC6,0xEE,0xBE,0x96,0x86,0x86,0x00,
//modified
0x41,0x63,0x77,0x5F,0x4B,0x43,0x43,0x00,
