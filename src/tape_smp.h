...
extern void main_leezx81(char *archivo_destino, char *texto_info_output,int si_load);
extern z80_byte *spec_smp_memory;
extern int tape_guessing_parameters;

extern int main_spec_rwaatap(long *array_block_positions,int max_array_block_positions);
